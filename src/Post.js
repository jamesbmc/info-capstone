    ...
    handleVote(e, action) {
        ...
        if (action === "up") {
            ...
            if (typeof this.props.info.downvotes !== "undefined" && this.props.info.downvotes.includes(firebase.auth().currentUser.uid)) {
                ...
                this.infoRef.update({upvotes: newDownvotes});
            }
            this.infoRef.update({upvotes: typeof this.props.info.upvotes === "undefined" ? [firebase.auth().currentUser.uid] : this.props.info.upvotes.concat(firebase.auth().currentUser.uid)});
        } else {
            console.log("down");
            if (typeof this.props.info.upvotes !== "undefined" && this.props.info.upvotes.includes(firebase.auth().currentUser.uid)) {
                ...
                this.infoRef.update({upvotes: newUpvotes});
            }
            this.infoRef.update({downvotes: typeof this.props.info.downvotes === "undefined" ? [firebase.auth().currentUser.uid] : this.props.info.downvotes.concat(firebase.auth().currentUser.uid)});
        }
    }
